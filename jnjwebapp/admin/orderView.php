    ...
    <span>Print Invoice</span>
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <div class="status-item <?php echo strtolower($status); ?> <?php if(strtolower($status) !== "pending" && strtolower($status) !== "processing" && strtolower($status) !== "shipped" && strtolower($status) !== "received" && strtolower($status) !== "cancelled") echo "inactive-status"; ?>" style="color: <?php echo $highlightColor; ?>">
                                <div>
...
<script>
    ...
    // Construct the URL for printInvoice.php with the orderID as a query parameter
    const printInvoiceURL = `printInvoice.php?orderID=${orderID}`;

    // Redirect the user to printInvoice.php
    window.location.href = printInvoiceURL;
});
