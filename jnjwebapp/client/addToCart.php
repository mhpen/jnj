...
if (isset($_POST['variation_id']) && isset($_POST['quantity']) && isset($_POST['product_id'])) {
    ...
    $sql = "INSERT INTO cart (userID, productID, ProductVarID, PersonalizationID, quantity, total) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iiiiid", $userID, $product_id, $variation_id, $personalization_id, $quantity, $total_price);
