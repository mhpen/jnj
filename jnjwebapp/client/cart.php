...
<script>
  ...
  function updateSubtotal() {
    ...
    // Calculate the total based on quantity of each item
  ...
  function checkout() {
    console.log("Checkout button clicked."); // Log a message for testing
    // Perform checkout process here
    // Redirect to checkout page or perform other actions as needed
  }
