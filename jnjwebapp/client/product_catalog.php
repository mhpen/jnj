<?php
// Include the chat interface file
include 'chat.php';
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <style>
        ...
        * {
        ...
        .container {
            ...
            width: 90%;
            position: relative; /* Ensure relative positioning for absolute children */
            z-index: 0; /* Lower z-index to ensure other elements appear above this container */
        }
        /* Navigation Section */
        .navigation {
            position: fixed;
...
<div class="search-filter">
    ...
    <!-- Chat interface -->
    <div id="chat-window1" class="chat-window" style="display: none; position: absolute; bottom: 20px; right: 20px; z-index: 999;"></div>
</body>
</html>
